...
.disaster-btn {
    ...
    &:hover {
        .icon {
            background: linear-gradient(180deg, rgba(255, 234, 127, 0) 0%, #FFEA7F 100%), radial-gradient(0% 60% at 17% 6%, #FFFBE6 0%, rgba(255, 234, 127, 1) 100%, rgba(255, 213, 0, 1) 100%), radial-gradient(0% 100% at 86% 100%, #FFFBE6 0%, rgba(255, 234, 127, 1) 100%);
        }
